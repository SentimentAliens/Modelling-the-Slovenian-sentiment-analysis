...
## Methology
<ol>
  <li>Detection of erronous labels in [dataset](https://www.clarin.si/
  repository/xmlui/handle/11356/1115). Refer [steps.md](/codes/STEPS.md.md) for pseudo code and explanation</li>
