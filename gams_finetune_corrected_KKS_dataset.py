...
# --------------------------------------------------------------------
VERSION = "V1" 
DATASET_PATH = "kks_v1_corrected.csv"
...
# Use 'sentiment' column for labels (which contains corrections in V1)
...
print(f"\n{VERSION} RESULTS:")
print(f"GaMS Accuracy (IFT corrected KKS dataset): {accuracy:.4f}")
print(f"GaMS Macro-F1 (IFT corrected KKS dataset): {f1_macro:.4f}")
